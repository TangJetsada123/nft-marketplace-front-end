                ...
                <div className="  bg-zinc-200 opacity-100 fixed inset-0 z-50 justify-center">
                    <div className="flex h-screen justify-center items-center ">
                        <div className="flex-col justify-center  bg-white py-12 px-24 border-4 border-black rounded-xl ">
                            <div className="flex  text-lg  text-zinc-600 mb-10 " >Create Your new Account Success!</div>
                        ...
                        {choice &&
                            <div>
                                <div className="   bg-zinc-200 opacity-95 fixed inset-0 z-50   ">
                                    <div className="flex h-screen justify-center items-center ">
                                        <div className="flex-col justify-center  bg-white py-12 px-24 border-4 border-black rounded-xl ">
                                            <div className="flex  text-lg  text-zinc-600 mb-10 ml-24" >You are Signing</div>
                                            <img src={metamask} className="w-44 ml-16" />
                                            <div className="flex ml-2 mt-2">
                                                ...
                                                {registerAccount &&
                                                    <div className="  bg-zinc-200 opacity-100 fixed inset-0 z-50 justify-center">
                                                        <div className="flex h-screen justify-center items-center ">
                                                            <div className="flex-col justify-center  bg-white py-12 px-24 border-4 border-black rounded-xl ">
                                                                <div className="flex  text-lg  text-zinc-600 mb-10 " >Create Your new password!</div>
                                                                <div className="flex ml-2 mt-2">
